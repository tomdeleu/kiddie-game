...
struct FeestState: Codable {
    ...
    /// is a pure function of the finished cake, evaluated once, at the party.
    /// Computed when she taps the VIP rope, then kept, so a friend who got her
    /// wish is still celebrating it after the app was closed mid-mouthful.
    ///
