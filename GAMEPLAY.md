...
- **The friend of the day is whoever the round brought**, or one the party
  deals on a visit, the way the decorating room deals a cake. The bakery no
  longer picks them on the way in.

**Completion in round mode** is tapping the cake, which hands a `FeestResult`
to §6.6. In visit mode it is the same tap, and with no photograph to hang it
