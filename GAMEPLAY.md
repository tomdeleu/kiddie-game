...
— one base clay body plus a swapped head and colour — and a 4-year-old reads
them instantly.
...
| Thing | Amount | Notes |
|---|---|---|
| Friend characters | 12 | One base clay body, swapped head and colour. Three-part rig from §9.7 — they only need to dance and jump. |
